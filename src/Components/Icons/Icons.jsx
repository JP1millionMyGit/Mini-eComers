const sizeIcon = 24;
const sizeIconBig = 30;
const sizeIconSmall = 16;

export function IconMenu({ click }){
  return(
    <svg 
...
export function IconCart({ click }){
  return (
    <>
      <svg 
        xmlns="http://www.w3.org/2000/svg" 
...
export function IconHome({ click }){
  return (
    <svg 
      xmlns="http://www.w3.org/2000/svg" 
      width={sizeIcon} 
...
export function IconClose({ click }){
  return (
    <svg 
      xmlns="http://www.w3.org/2000/svg" 
      width={sizeIconBig} 
...
export function IconPopular({ click }){
  return (
    <svg 
      xmlns="http://www.w3.org/2000/svg" 
      width={24} 
...
export function IconDown({ click }){
  return (
    <svg 
      xmlns="http://www.w3.org/2000/svg" 
      width={sizeIconSmall} 
...
export function IconSearch({ click }){
  return (
    <svg 
      xmlns="http://www.w3.org/2000/svg" 
      width={sizeIconBig} 
    ...
    >
      <path 
        fill="currentColor" 
        fillRule="evenodd" 
        d="M14.385 15.446a6.75 6.75 0 1 1 1.06-1.06l5.156 5.155a.75.75 0 1 1-1.06 1.06zm-7.926-1.562a5.25 5.25 0 1 1 7.43-.005l-.005.005l-.005.004a5.25 5.25 0 0 1-7.42-.004" clipRule="evenodd"
      ></path>
    </svg>
  )
}
